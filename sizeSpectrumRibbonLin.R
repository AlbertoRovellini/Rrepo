...
library(ggplot2)
setwd("C:/Users/Alberto/Documents/itn100results/size500_i3/ind/half")
list<-list.files("C:/Users/Alberto/Documents/itn100results/size500_i3/ind/half", 
...
frequencies <-function(data) { # function to extract the frequencies for each replicate
        ...
        freq[freq<5] <- NA # lower limit of resoulution, gets rid of the outliers. kek
