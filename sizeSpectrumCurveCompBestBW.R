...
I1Comp <- ggplot(data=subset(total, Regime=="Base" | Regime=="U_I1"| Regime=="S500_I1"| Regime=="C_I1"
                 ...
                 aes(x=x, y=y, linetype=Regime, color=Regime))+
        geom_line(size=1)+
        ...
        scale_y_continuous(name="ln(number of individuals)", 
                           limits=c(0,11),
                           breaks=c(0:11))+
        scale_linetype_manual(values=c(1,rep(c(1,2,3),2)))+
        scale_colour_manual(name="Regime",
                            values=c("#E41A1C", rep(c("black", "darkgrey"),3)))+
...
ggsave("C:/Users/Alberto/Documents/LaTeX/latexdirectory/picsWP/spectrumCompI1.pdf", I1Comp, useDingbats=FALSE ) # set better res pls
...
ggsave("C:/Users/Alberto/Documents/LaTeX/latexdirectory/picsWP/spectrumCompI2.pdf", I2Comp, useDingbats=FALSE ) # set better res pls
...
ggsave("C:/Users/Alberto/Documents/LaTeX/latexdirectory/picsWP/spectrumCompI3.pdf", I3Comp, useDingbats=FALSE ) # set better res pls
